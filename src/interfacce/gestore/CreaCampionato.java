...
public class CreaCampionato extends JFrame {
    ...
    private void setInfoIcon() {
        ...
        astaInfo.setToolTipText("<html>Se si sceglie live l'asta verrà fatta tramite l'gestore.<br> Se si sceglie offline bisogna inserire manualmente le singole rose</html>");
